    ...
    <div className="legal-section-title">
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Medicia Plus, your trusted online healthcare platform. Our
        ...
        <p className="legal-description">
          When using Medicia Plus, you agree to our Terms of Service. This
        ...
        <p className="legal-description">
        Medicia Plus is designed to simplify healthcare access. You can choose
