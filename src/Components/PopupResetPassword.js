...
const PopupResetPassword = ({ onClose, id }) => {
    ...
    const onConnect = async () => {
        try {
            ...
            if (currProvider) {
                ...
                if (OP === oldPassword) {
                    const NP = await ContractInstance.methods.resetPatientPassword(id, newPassword).send({ from: userAccounts[0], gas: 3000000 });
            ...
            console.log("Error at PopupResetPassword");
            console.error(error);
